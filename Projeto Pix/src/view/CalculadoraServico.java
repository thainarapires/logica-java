...
public class CalculadoraServico extends JFrame {
	...
	public CalculadoraServico() {
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(CalculadoraServico.class.getResource("/img/54829_calculator_iphone app_app_icon.png")));
		...
		btnCalcular.setIcon(new ImageIcon(
				CalculadoraServico.class.getResource("/img/6590488_and_calculator_education_learning_maths_icon.png")));
